...
function Cards({ heading }) {
  ...
  //   {
  //     img: "fI1.png",
  //     name: "Music concert at Hingo 2025 | USA",
  //     date: "March 23 | 6 PM",
  //     location: "Jio world, Mumbai",
  //     category:"Music",
  //     start:"11 Dec 2024",
  //     end:"15 Dec 2024",
  //     organiser:"TripPlanner"
  //   },
  //   {
  //     img: "fI2.png",
  //     name: "Music concert & Disco Night | USA",
  //     date: "March 24 | 6 PM",
  //     location: "New Mumbai, Mumbai",
  //     category:"Music",
  //     start:"11 Dec 2024",
  //     end:"15 Dec 2024",
  //     organiser:"TripPlanner"
    ...
    <div className="flex lg:justify-start  justify-center lg:relative left-20 items-center overflow-hidden">
      <div className="lg:p-12 pt-5 p-5 w-full max-w-[1340px]">
        <div className="flex justify-between">
          ...
          <button className="shadow-md lg:text-base text-sm p-2 font-medium">
            View All
          </button>
        </div>
