...
import { updateUserProfile, getUserProfile } from "../redux/actions/master/profileActions";
import { changePassword } from "../redux/actions/master/authActions";
...
function Profile() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      await dispatch(changePassword(formDataToSend));
      ...
      <div className="w-full max-w-5xl bg-white shadow-lg rounded-lg mt-20 sm:mt-0">
        ...
        {loading && (
          <div className="flex justify-center items-center p-4">
            <div className="text-[#ff2459]">Loading profile...</div>
          </div>
        )}
        ...
        {activeTab === "personaldetails" && !loading && (
