...
//   ];
//   return (
//     <div className="bg-[#cfcfcf] w-full">
//       <div className="flex flex-col text-lg md:text-base md:flex-row lg:flex-row justify-between p-5 pb-1 pl-10 pr-10 ">
//         <div className="flex gap-12 flex-col md:flex-row lg:flex-row  ">
//           <div className=" flex flex-col">
//             <Link className="font-semibold pb-4   hover:text-blue-800  text-xl md:text-lg ">
//               UseFull Links
//             </Link>
//             <div className="flex flex-col gap-2  text-base ">
//               <Link className=" hover:text-blue-800 ">About</Link>
//               <Link className="  hover:text-blue-800 ">Events</Link>
//               <Link className="  hover:text-blue-800 ">Blogs</Link>
//               <Link className="  hover:text-blue-800 ">Terms & Conditions</Link>
//               <Link className="  hover:text-blue-800 ">Privacy Policies</Link>
//             </div>
//           </div>
...
//             </Link>
//             <div className="flex flex-col gap-2 text-base">
//               <Link className="  hover:text-blue-800 ">FaceBook</Link>
//               <Link className="  hover:text-blue-800 ">Twitter</Link>
//               <Link className="  hover:text-blue-800 ">Instagram</Link>
//               <Link className="  hover:text-blue-800 ">Linkdin</Link>
//             </div>
//           </div>
//           <div className=" flex flex-col ">
//             <Link className="font-semibold pb-4   hover:text-blue-800 text-xl md:text-lg ">
...
//               <Link className=" hover: hover:text-blue-800   ">
//                 Send us a Message
//               </Link>
//               <Link className=" hover:text-blue-800 ">FInd us on map</Link>
//               <Link className=" hover:text-blue-800 ">Instagram</Link>
//               <Link className=" hover:text-blue-800 ">Linkdin</Link>
//             </div>
//           </div>
...
//         <div className="flex flex-col gap-3 md:m-2 m-8">
//           <img src="/logo.png" className="h-12 w-64 m" />
//          <div className="flex">
//          <input type="text" className="w-full rounded-l-2xl p-1" /> 
//          <button className="bg-[#ff2459] p-2 rounded-r-2xl text-white">Subscribe</button>
//          </div>
//         </div>
//       </div>
//       <div className="flex text-lg justify-center p-1 font-medium">All Cities</div>
//       <div>
//         <ul
//           className="w-full grid grid-cols-3 grid-rows-3  md:flex  md:flex-row justify-center p-1 text-lg"
          
//         >
//           {cities.map((item, index) => {
//             return <li style={{ listStyleType: "disc",listStylePosition:"inside" }} className="p-3" key={index}>{item}</li>;
//           })}
//         </ul>
//       </div>
//       <div className="flex flex-col items-center gap-2 p-3">
//         <p>2024 EventNode @ CopyRight</p>
//         <p>Product by @bytes Solution</p>
//       </div>
//     </div>
//   );
// }
