...
import {
  FaRegFileAlt, FaPlus, FaTrash, FaBars, FaEye, FaPencilAlt, FaSort, FaSortUp, FaSortDown, FaTimes
} from 'react-icons/fa';

const AdminPages = ({ pages, setPages, onNavigateToCreatePage }) => {
      ...
      <div className="flex justify-between items-center bg-transparent p-0 rounded-lg mb-6">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="flex items-center bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-4 text-sm rounded-full shadow-sm transition-colors duration-200">
