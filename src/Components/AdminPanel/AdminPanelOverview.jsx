...
{name:"Currencies", icon:<FaRupeeSign />, id:"adminCurrencies"},
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
           ...
           className={`bg-gray-900 text-white h-screen p-2 pt-5 fixed top-0 left-0 transition-all duration-300 z-40 ${
          isSidebarExpanded ? "w-56" : "w-14"
        }`}
           >

<div className="flex items-center space-x-2 mb06">
    <img
    ...
    {sections.map((item) => (
          <div
            ...
            className={`flex items-center space-x-3 cursor-pointer p-3 rounded hover:bg-gray-700 ${
...
<main className="flex-1 pt-20 ml-10 px-4 p-4 md:p-6 mt-16 md:mt-0 overflow-y-auto">
      {activeSection === "adminCategories" && <Categories />}
       {activeSection === "adminEvents" && <Events />}
        ...
        {activeSection === "adminPages" && <Pages />}
        {activeSection === "adminBlogPosts" && <Blog Posts />}
