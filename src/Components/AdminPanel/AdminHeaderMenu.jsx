...
import { FaList, FaPlus, FaTrash, FaPencilAlt, FaGripVertical, FaSave, FaTimes, FaLink, FaHome, FaGlobe, FaFolder, FaEdit, FaTrashAlt } from 'react-icons/fa';

const initialMenuItems = [
    { id: 1, label: 'Home', url: '/', type: 'Page', order: 1 },
    { id: 2, label: 'About Us', url: '/about', type: 'Page', order: 2 },
    { id: 3, label: 'Events', url: '/events', type: 'Category', order: 3 },
    { id: 4, label: 'Blog', url: 'https://medium.com/my-blog', type: 'Custom Link', order: 4 },
    { id: 5, label: 'Contact', url: '/contact', type: 'Page', order: 5 },
];
...
const AdminHeaderMenu = () => {
    ...
    const AddMenuModal = ({ onSave, onCancel }) => (
        <>
                    ...
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-3 sm:p-4 rounded-t-xl sm:rounded-t-2xl">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                ...
                                <h2 className="text-base sm:text-lg font-bold text-white">Add New Menu Item</h2>
                            </div>
                            <button 
                                onClick={onCancel}
                    ...
                    <form onSubmit={onSave} className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div className="space-y-1">
                                <label className="block text-xs font-semibold text-gray-700">Menu Label</label>
                                <input 
                                    name="label" 
                                    type="text" 
                            ...
                            <div className="space-y-1">
                                <label className="block text-xs font-semibold text-gray-700">Menu Type</label>
                                <select 
                                    name="type" 
        ...
        <div className="relative">
            ...
            <form onSubmit={onSave} className="relative bg-white p-3 sm:p-4 rounded-xl border-2 border-indigo-200 shadow-lg">
                <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-sm sm:text-base font-semibold text-gray-800">Edit Menu Item</h3>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <select 
                            name="type" 
                            defaultValue={item?.type || 'Custom Link'}
                            className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-sm"
                        >
                            <option value="Page">Page</option>
                            <option value="Category">Category</option>
                        ...
                        <div className="flex flex-col space-y-3">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                                <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-2 rounded-xl shadow-lg">
                                    <FaList className="text-lg sm:text-xl text-white" />
                                </div>
                                <div className="flex-grow">
                                    ...
                                    <p className="text-xs sm:text-sm text-gray-600 mt-1">Manage your website's navigation menu</p>
                                </div>
                                {/* Add Menu Button */}
                                {!editingItem && (
                                    <button 
                            ...
                            {sortedMenuItems.length === 0 && (
                                <div className="text-center py-6 sm:py-8">
                                    <div className="bg-gray-100 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mx-auto mb-3">
                                        <FaList className="text-gray-400 text-lg sm:text-xl" />
                                    </div>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-600 mb-1">No menu items yet</h3>
                                    <p className="text-xs sm:text-sm text-gray-500">Add your first menu item to get started</p>
                                </div>
                            )}
                        </div>
                    </div>
