...
import { FaUserPlus, FaArrowLeft, FaSearch, FaTimes, FaEye, FaEyeSlash } from 'react-icons/fa';
...
const AddUser = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axiosInstance.post('/auth/add-user', formData);
            if (response.data.status) {
