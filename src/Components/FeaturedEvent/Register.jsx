...
//       <div className="w-[360px] h-[550px] pb-5 flex flex-col gap-3">
//         <InputField
//           label={"First Name"}
//           type={"text"}
//           name={"firstName"}
...
//           />
//         </div>
//         <div className="flex flex-col justify-center  items-center w-full md:w-1/2 px-4 md:px-8 py-3 h-full bg-gray-100 lg:pt-5 mt-4  ">
