...
import React from "react";
//todo change fdid var name to fbUrl
function FacebookEmbeded({appId, fbId}) {
    console.log("fbId", fbId);
    console.log(fbId)
    var id
    if (!identifyFbId(fbId)) {
        id = convertToFacebookEmbedUrlAndPageId(fbId);
    }
    ...
    return (
        <div className="flex justify-center items-center w-full">
          ...
          `}
                ...
                <iframe
                    src={`https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F${id}&tabs=timeline&width=500&height=700&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=${appId}`}
